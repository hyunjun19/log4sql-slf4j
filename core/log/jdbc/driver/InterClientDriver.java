 ...
 * Usage    :
 */
public class InterClientDriver extends DriverLoggables {
    public InterClientDriver() {
        setDriver(INTERCLIENT_DRIVER);
    }

    static {
        try {
            DriverManager.registerDriver(new InterClientDriver());
