 ...
 * Usage    :
 */
public class JdataStoreDriver extends DriverLoggables {
    public JdataStoreDriver() {
        setDriver(JDATASTORE_DRIVER);
    }

    static {
        try {
            DriverManager.registerDriver(new JdataStoreDriver());
